...
enum class Topic
{
    ...
    as_commands = 43,
    as_commands_set_values = 44,
    as_commands_set_status = 45,
    file_transaction_request = 46,
    file_transaction_response = 47,
    file_transaction = 48,
    file_transaction_begin = 49,
    file_transaction_end = 50,
    file_transaction_chunk = 51,
    file_transaction_chunk_ack = 52,
    info = 53,
    info_version = 54,
    info_user = 55,
    info_telemetry_replay = 56,
    info_telemetry_replay_ready = 57,
    info_telemetry_replay_start = 58,
    info_session = 59,
    info_session_started = 60,
    info_session_stopped = 61,
    info_session_keepalive = 62,
    info_new_lap = 63,
    action = 64,
    action_telemetry_config = 65,
    action_telemetry_config_set = 66,
    action_telemetry_config_get = 67,
    action_telemetry_config_content = 68,
    action_session_config = 69,
    action_session_config_set = 70,
    action_session_config_get = 71,
    action_session_config_content = 72,
    action_car_config = 73,
    action_car_config_set = 74,
    action_car_config_get = 75,
    action_car_config_content = 76,
    action_baseline_config = 77,
    action_baseline_config_set = 78,
    action_baseline_config_get = 79,
    action_baseline_config_content = 80,
    action_handcart_settings = 81,
    action_handcart_settings_set = 82,
    action_handcart_settings_get = 83,
    action_handcart_settings_content = 84,
    raw_json_config = 85,
    raw_json_config_set = 86,
    raw_json_config_get = 87,
    raw_json_config_content = 88,
    action_lap_counter_config = 89,
    action_lap_counter_config_set = 90,
    action_lap_counter_config_get = 91,
    action_lap_counter_config_content = 92,
    action_lap_counter_track = 93,
    action_lap_counter_track_set = 94,
    action_lap_counter_track_get = 95,
    action_lap_counter_track_content = 96,
    action_kill = 97,
    action_start = 98,
    action_reset = 99,
    action_stop = 100,
    ...
    query = 110,
    query_lap_counter_layouts = 111,
    query_lap_counter_layouts_get = 112,
    query_lap_counter_layouts_set = 113,
    query_lap_counter_layouts_content = 114,
    query_lap_counter_times = 115,
    query_lap_counter_times_get = 116,
    query_lap_counter_times_set = 117,
    query_lap_counter_times_content = 118,
    query_lap_counter_lap_records = 119,
    query_lap_counter_lap_records_get = 120,
    query_lap_counter_lap_records_set = 121,
    query_lap_counter_lap_records_content = 122,
    query_gps_origins = 123,
    query_gps_origins_get = 124,
    query_gps_origins_set = 125,
    query_gps_origins_content = 126,
    query_baseline = 127,
    query_baseline_get = 128,
    query_baseline_set = 129,
    query_baseline_content = 130,
    query_custom_plots = 131,
    query_custom_plots_get = 132,
    query_custom_plots_set = 133,
    query_custom_plots_content = 134
};
