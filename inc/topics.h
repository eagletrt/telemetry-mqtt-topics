...
enum class Topic
{
    ...
    info_user = 51,
    info_session = 52,
    info_session_started = 53,
    info_session_stopped = 54,
    info_session_keepalive = 55,
    action = 56,
    action_telemetry_config = 57,
    action_telemetry_config_set = 58,
    action_telemetry_config_get = 59,
    action_telemetry_config_content = 60,
    action_session_config = 61,
    action_session_config_set = 62,
    action_session_config_get = 63,
    action_session_config_content = 64,
    action_car_config = 65,
