...
enum class Topic
{
    ...
    query_track_by_session = 132,
    query_track_by_session_get = 133,
    query_track_by_session_content = 134,
    query_lap_counter_layouts = 135,
    query_lap_counter_layouts_get = 136,
    query_lap_counter_layouts_set = 137,
    query_lap_counter_layouts_content = 138,
    query_lap_counter_times = 139,
    query_lap_counter_times_get = 140,
    query_lap_counter_times_set = 141,
    query_lap_counter_times_content = 142,
    query_lap_counter_lap_records = 143,
    query_lap_counter_lap_records_get = 144,
    query_lap_counter_lap_records_set = 145,
    query_lap_counter_lap_records_content = 146,
    query_gps_origins = 147,
    query_gps_origins_get = 148,
    query_gps_origins_set = 149,
    query_gps_origins_content = 150,
    query_baseline = 151,
    query_baseline_get = 152,
    query_baseline_set = 153,
    query_baseline_content = 154,
    query_custom_plots = 155,
    query_custom_plots_get = 156,
    query_custom_plots_set = 157,
    query_custom_plots_content = 158
};
