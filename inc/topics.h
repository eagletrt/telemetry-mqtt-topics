...
enum class Topic
{
    ...
    info = 55,
    info_version = 56,
    info_version_serializers = 57,
    info_version_mqtt_topics = 58,
    info_version_gpslib = 59,
    info_version_libcommunications = 60,
    info_user = 61,
    info_telemetry_replay = 62,
    info_telemetry_replay_ready = 63,
    info_telemetry_replay_start = 64,
    info_session = 65,
    info_session_started = 66,
    info_session_stopped = 67,
    info_session_keepalive = 68,
    info_new_lap = 69,
    action = 70,
    action_telemetry_config = 71,
    action_telemetry_config_set = 72,
    action_telemetry_config_get = 73,
    action_telemetry_config_content = 74,
    action_session_config = 75,
    action_session_config_set = 76,
    action_session_config_get = 77,
    action_session_config_content = 78,
    action_car_config = 79,
    action_car_config_set = 80,
    action_car_config_get = 81,
    action_car_config_content = 82,
    action_baseline_config = 83,
    action_baseline_config_set = 84,
    action_baseline_config_get = 85,
    action_baseline_config_content = 86,
    action_handcart_settings = 87,
    action_handcart_settings_set = 88,
    action_handcart_settings_get = 89,
    action_handcart_settings_content = 90,
    raw_json_config = 91,
    raw_json_config_set = 92,
    raw_json_config_get = 93,
    raw_json_config_content = 94,
    action_lap_counter_config = 95,
    action_lap_counter_config_set = 96,
    action_lap_counter_config_get = 97,
    action_lap_counter_config_content = 98,
    action_lap_counter_track = 99,
    action_lap_counter_track_set = 100,
    action_lap_counter_track_get = 101,
    action_lap_counter_track_content = 102,
    action_kill = 103,
    action_start = 104,
    action_reset = 105,
    action_stop = 106,
    action_start_baseline = 107,
    action_stop_baseline = 108,
    action_precharge = 109,
    action_balance = 110,
    action_stop_balance = 111,
    action_charge = 112,
    action_stop_charge = 113,
    action_raw = 114,
    action_reset_lap_counter = 115,
    query = 116,
