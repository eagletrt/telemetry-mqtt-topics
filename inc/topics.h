...
enum class Topic
{
    ...
    as_commands = 47,
    as_commands_set_values = 48,
    as_commands_set_status = 49,
    file_transaction_request = 50,
    file_transaction_response = 51,
    file_transaction = 52,
    file_transaction_begin = 53,
    file_transaction_end = 54,
    file_transaction_chunk = 55,
    file_transaction_chunk_ack = 56,
    info = 57,
    info_version = 58,
    info_user = 59,
    info_telemetry_replay = 60,
    info_telemetry_replay_ready = 61,
    info_telemetry_replay_start = 62,
    info_session = 63,
    info_session_started = 64,
    info_session_stopped = 65,
    info_session_keepalive = 66,
    info_new_lap = 67,
    action = 68,
    action_telemetry_config = 69,
    action_telemetry_config_set = 70,
    action_telemetry_config_get = 71,
    action_telemetry_config_content = 72,
    action_session_config = 73,
    action_session_config_set = 74,
    action_session_config_get = 75,
    action_session_config_content = 76,
    action_car_config = 77,
    action_car_config_set = 78,
    action_car_config_get = 79,
    action_car_config_content = 80,
    action_baseline_config = 81,
    action_baseline_config_set = 82,
    action_baseline_config_get = 83,
    action_baseline_config_content = 84,
    action_handcart_settings = 85,
    action_handcart_settings_set = 86,
    action_handcart_settings_get = 87,
    action_handcart_settings_content = 88,
    raw_json_config = 89,
    raw_json_config_set = 90,
    raw_json_config_get = 91,
    raw_json_config_content = 92,
    action_lap_counter_config = 93,
    action_lap_counter_config_set = 94,
    action_lap_counter_config_get = 95,
    action_lap_counter_config_content = 96,
    action_lap_counter_track = 97,
    action_lap_counter_track_set = 98,
    action_lap_counter_track_get = 99,
    action_lap_counter_track_content = 100,
    action_kill = 101,
    action_start = 102,
    action_reset = 103,
    action_stop = 104,
    action_start_baseline = 105,
    action_stop_baseline = 106,
    action_precharge = 107,
    action_balance = 108,
    action_stop_balance = 109,
    action_charge = 110,
    action_stop_charge = 111,
    action_raw = 112,
    action_reset_lap_counter = 113,
    query = 114,
    query_lap_counter_layouts = 115,
    query_lap_counter_layouts_get = 116,
    query_lap_counter_layouts_set = 117,
    query_lap_counter_layouts_content = 118,
    query_lap_counter_times = 119,
    query_lap_counter_times_get = 120,
    query_lap_counter_times_set = 121,
    query_lap_counter_times_content = 122,
    query_lap_counter_lap_records = 123,
    query_lap_counter_lap_records_get = 124,
    query_lap_counter_lap_records_set = 125,
    query_lap_counter_lap_records_content = 126,
    query_gps_origins = 127,
    query_gps_origins_get = 128,
    query_gps_origins_set = 129,
    query_gps_origins_content = 130,
    query_baseline = 131,
    query_baseline_get = 132,
    query_baseline_set = 133,
    query_baseline_content = 134,
    query_custom_plots = 135,
    query_custom_plots_get = 136,
    query_custom_plots_set = 137,
    query_custom_plots_content = 138
};
