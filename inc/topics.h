...
enum class Topic
{
    ...
    action = 48,
    action_telemetry_config = 49,
    action_telemetry_config_set = 50,
    action_telemetry_config_get = 51,
    action_telemetry_config_content = 52,
    action_session_config = 53,
    action_session_config_set = 54,
    action_session_config_get = 55,
    action_session_config_content = 56,
    action_car_config = 57,
    action_car_config_set = 58,
    action_car_config_get = 59,
    action_car_config_content = 60,
    action_handcart_settings = 61,
    action_handcart_settings_set = 62,
    action_handcart_settings_get = 63,
    action_handcart_settings_content = 64,
    action_lap_counter_config = 65,
    action_lap_counter_config_set = 66,
    action_lap_counter_config_get = 67,
    action_lap_counter_config_content = 68,
    action_lap_counter_track = 69,
    action_lap_counter_track_set = 70,
    action_lap_counter_track_get = 71,
    action_lap_counter_track_content = 72,
    action_kill = 73,
    action_start = 74,
    action_reset = 75,
    action_stop = 76,
    action_start_baseline = 77,
    action_stop_baseline = 78,
    action_precharge = 79,
    action_balance = 80,
    action_stop_balance = 81,
    action_charge = 82,
    action_stop_charge = 83,
    action_raw = 84,
    action_reset_lap_counter = 85,
    action_set_lap_counter_status = 86
};
