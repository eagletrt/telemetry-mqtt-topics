#ifndef ACTION_START_TELEMETRY_TOPIC_H
#define ACTION_START_TELEMETRY_TOPIC_H
...
namespace MQTTTopics {
    ...
    {
    public:
        ActionStartTelemetryTopic() = delete;
        ActionStartTelemetryTopic(const ActionStartTelemetryTopic &) = delete;
        ActionStartTelemetryTopic &operator=(const ActionStartTelemetryTopic &) = delete;
        ~ActionStartTelemetryTopic() = delete;
