...
enum TOPICS_T {
    ...
    TOPIC_STATUS_CAN_FREQUENCIES = 13,
    TOPIC_STATUS_ALERT = 14,
    TOPIC_COMMAND = 15,
    TOPIC_COMMAND_SEND = 16,
    TOPIC_COMMAND_RESULT = 17,
    TOPIC_FILE_TRANSACTION_REQUEST = 18,
    TOPIC_FILE_TRANSACTION_RESPONSE = 19,
    TOPIC_FILE_TRANSACTION = 20,
    TOPIC_FILE_TRANSACTION_BEGIN = 21,
    TOPIC_FILE_TRANSACTION_END = 22,
    TOPIC_FILE_TRANSACTION_CHUNK = 23,
    TOPIC_FILE_TRANSACTION_CHUNK_ACK = 24,
    TOPIC_ACTION = 25,
    TOPIC_ACTION_TELEMETRY_CONFIG = 26,
    TOPIC_ACTION_TELEMETRY_CONFIG_SET = 27,
    TOPIC_ACTION_TELEMETRY_CONFIG_GET = 28,
    TOPIC_ACTION_TELEMETRY_CONFIG_CONTENT = 29,
    TOPIC_ACTION_SESSION_CONFIG = 30,
    TOPIC_ACTION_SESSION_CONFIG_SET = 31,
    TOPIC_ACTION_SESSION_CONFIG_GET = 32,
    TOPIC_ACTION_SESSION_CONFIG_CONTENT = 33,
    TOPIC_ACTION_CAR_CONFIG = 34,
    TOPIC_ACTION_CAR_CONFIG_SET = 35,
    TOPIC_ACTION_CAR_CONFIG_GET = 36,
    TOPIC_ACTION_CAR_CONFIG_CONTENT = 37,
    TOPIC_ACTION_HANDCART_SETTINGS = 38,
    TOPIC_ACTION_HANDCART_SETTINGS_SET = 39,
    TOPIC_ACTION_HANDCART_SETTINGS_GET = 40,
    TOPIC_ACTION_HANDCART_SETTINGS_CONTENT = 41,
