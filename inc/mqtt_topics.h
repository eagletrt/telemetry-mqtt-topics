...
enum TOPICS_T {
    ...
    TOPIC_COMMAND = 14,
    TOPIC_COMMAND_SEND = 15,
    TOPIC_COMMAND_RESULT = 16,
    TOPIC_FILE_TRANSACTION_REQUEST = 17,
    TOPIC_FILE_TRANSACTION_RESPONSE = 18,
    TOPIC_FILE_TRANSACTION = 19,
    TOPIC_FILE_TRANSACTION_BEGIN = 20,
    TOPIC_FILE_TRANSACTION_END = 21,
    TOPIC_FILE_TRANSACTION_CHUNK = 22,
    TOPIC_FILE_TRANSACTION_CHUNK_ACK = 23,
    TOPIC_ACTION = 24,
    TOPIC_ACTION_TELEMETRY_CONFIG = 25,
    TOPIC_ACTION_TELEMETRY_CONFIG_SET = 26,
    TOPIC_ACTION_TELEMETRY_CONFIG_GET = 27,
    TOPIC_ACTION_TELEMETRY_CONFIG_CONTENT = 28,
    TOPIC_ACTION_SESSION_CONFIG = 29,
    TOPIC_ACTION_SESSION_CONFIG_SET = 30,
    TOPIC_ACTION_SESSION_CONFIG_GET = 31,
    TOPIC_ACTION_SESSION_CONFIG_CONTENT = 32,
    TOPIC_ACTION_CAR_CONFIG = 33,
    TOPIC_ACTION_CAR_CONFIG_SET = 34,
    TOPIC_ACTION_CAR_CONFIG_GET = 35,
    TOPIC_ACTION_CAR_CONFIG_CONTENT = 36,
    TOPIC_ACTION_HANDCART_SETTINGS = 37,
    TOPIC_ACTION_HANDCART_SETTINGS_SET = 38,
    TOPIC_ACTION_HANDCART_SETTINGS_GET = 39,
    TOPIC_ACTION_HANDCART_SETTINGS_CONTENT = 40,
