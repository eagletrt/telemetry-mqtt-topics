...
class Topic(Enum):
    ...
    status_mongo_manager_status = auto(),
    as_commands = auto(),
    ...
    query_influx_data_set = auto(),
    query_influx_data_content = auto(),
    query_influx_data_status = auto(),
    ...
    query_track_by_session = auto(),
    query_track_by_session_get = auto(),
    query_track_by_session_content = auto(),
...
def GetTopicStatusMongoManagerStatus(vehicleId, deviceId):
    topic = vehicleId + "/" + deviceId + "/" + "status/MongoManagerStatus"
    return topic
...
def GetTopicQueryInfluxData(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "data"
    return topic

def GetTopicQueryInfluxDataGet(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "data/get"
    return topic

def GetTopicQueryInfluxDataSet(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "data/set"
    return topic

def GetTopicQueryInfluxDataContent(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "data/content"
    return topic

def GetTopicQueryInfluxDataStatus(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "data/status"
    return topic

def GetTopicQuerySessionByYearMonth(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "SessionByYearMonth"
    return topic

def GetTopicQuerySessionByYearMonthGet(vehicleId, deviceId, transactionId):
...
def GetTopicQuerySessionByDayRange(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "SessionByDayRange"
    return topic

def GetTopicQuerySessionByDayRangeGet(vehicleId, deviceId, transactionId):
...
def GetTopicQueryTrackBySession(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "TrackBySession"
    return topic

def GetTopicQueryTrackBySessionGet(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "TrackBySession/get"
    return topic

def GetTopicQueryTrackBySessionContent(vehicleId, deviceId, transactionId):
    topic = vehicleId + "/" + deviceId + "/" + "query" + "/" + transactionId + "/" + "TrackBySession/content"
    return topic
...
def GetSubscribeTopics(role, vehicleId, deviceId, transactionId):
    ...
    match role:
        case Role.role_0:
            ...
            ret.append(GetTopicQueryInfluxDataStatus(vehicleId, deviceId, transactionId))
            ...
            ret.append(GetTopicQueryTrackBySession(vehicleId, deviceId, transactionId))
            ret.append(GetTopicQueryTrackBySessionContent(vehicleId, deviceId, transactionId))
        ...
        case Role.role_131:
            ...
            ret.append(GetTopicQueryTrackBySession(vehicleId, deviceId, transactionId))
            ret.append(GetTopicQueryTrackBySessionGet(vehicleId, deviceId, transactionId))
            ret.append(GetTopicQueryLapCounterLayouts(vehicleId, deviceId, transactionId))
