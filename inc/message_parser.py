...
class MessageParser:
    ...
    def __init__(self):
        ...
        self.addNode("<vehicleId>/<deviceId>/extra_tlm_data/lapTimes",4)
        self.addNode("<vehicleId>/<deviceId>/extra_tlm_data/lapRecords",4)
        self.addNode("<vehicleId>/<deviceId>/extra_tlm_data/lapLayout",4)
        ...
        self.addNode("<vehicleId>/<deviceId>/info/trackConfig",4)
        ...
        self.addNode("<vehicleId>/<deviceId>/info/version/lib-communications",5)
        ...
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/data/set",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/data/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/data/status",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByYearMonth",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByYearMonth/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByYearMonth/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByDayRange",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByDayRange/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByDayRange/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLayouts",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLayouts/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLayouts/set",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLayouts/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/set",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/set",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/set",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/content",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/baseline",5)
    ...
    def findNode(self, variables, topic):
        ...
        def segment_matches(node_name, segment):
            return node_name == segment or node_name in ("<vehicleId>", "<deviceId>", "<transactionId>", "+", "#")

        def walk(node, index):
            if index == len(topic_split):
                return node

            for child in node.children:
                if segment_matches(child.name, topic_split[index]):
                    matched_node = walk(child, index + 1)
                    if matched_node is not None:
                        return matched_node

            return None

        if segment_matches(self.tree.name, topic_split[0]):
            return walk(self.tree, 1)
