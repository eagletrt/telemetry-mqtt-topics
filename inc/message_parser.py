...
class MessageParser:
    ...
    def __init__(self):
        ...
        self.addNode("<vehicleId>/<deviceId>/action/odometer",4)
        self.addNode("<vehicleId>/<deviceId>/action/odometer/set",5)
        self.addNode("<vehicleId>/<deviceId>/action/odometer/get",5)
        self.addNode("<vehicleId>/<deviceId>/action/odometer/content",5)
