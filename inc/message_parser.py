...
class MessageParser:
    ...
    def __init__(self):
        ...
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByYearMonth/set",6)
        ...
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/SessionByDayRange/set",6)
