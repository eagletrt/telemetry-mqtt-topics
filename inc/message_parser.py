...
class MessageParser:
    ...
    def __init__(self):
        ...
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/DocumentsBySession",5)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/DocumentsBySession/get",6)
        self.addNode("<vehicleId>/<deviceId>/query/<transactionId>/DocumentsBySession/content",6)
