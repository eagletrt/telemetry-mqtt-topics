...
namespace MQTTTopics {
    const std::string FileTransactionBeginTopic::topic = "fenice-evo/<device_id>/file_transaction/<transaction-id>/begin";
    ...
    TopicString FileTransactionBeginTopic::get(const std::string& device_id, const std::string& transaction-id) {
