...
MessageParser::MessageParser() {
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can/imuAngularRate");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can/imuAcceleration");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can/vehiclePosition");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can/vehicleSpeed");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera_logger/can/frontAngularVelocity");
