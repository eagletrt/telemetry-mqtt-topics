...
MessageParser::MessageParser() {
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/imuAngularRate");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/imuAcceleration");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/vehiclePosition");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/vehicleSpeed");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/frontAngularVelocity");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/rearLeftAngularVelocity");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/can/rearRightAngularVelocity");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/gps");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/gps/HPPOSLLH");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/gps/PVT");
    this->tree.addNode("<vehicleId>/<deviceId>/data/camera-logger/gps/RELPOSNED");
