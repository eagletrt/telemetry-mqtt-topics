...
MessageParser::MessageParser() {
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/info/trackConfig");
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/info/version/lib-communications");
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/info/newLap");
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession/get");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/TrackBySession/content");
    ...
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLayouts/content");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/get");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/set");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterTimes/content");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/get");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/set");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/LapCounterLapRecords/content");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/get");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/set");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/GpsOrigins/content");
    this->tree.addNode("<vehicleId>/<deviceId>/query/<transactionId>/baseline");
