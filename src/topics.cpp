...
std::vector<TopicMessage> GetSubscribeTopics(Role role, const std::string& vehicleId, const std::string& deviceId, const std::string& transactionId) {
    ...
    switch(role) {
        ...
        ret.emplace_back(GetTopicquery(vehicleId));
        ret.emplace_back(GetTopicResponse(vehicleId));
...
TopicMessage GetTopic(Topic topic, const std::string& vehicleId, const std::string& deviceId, const std::string& transactionId) {
    switch(topic) {
        ...
        case Topic::query: 
            return GetTopicquery(vehicleId);
        case Topic::response: 
            return GetTopicResponse(vehicleId);
        case Topic::simulator: 
...
TopicMessage GetTopicquery(const std::string& vehicleId) {
    std::string topic = vehicleId + "/" + "query";
    int qos = 0;
    bool retain = false;
...
TopicMessage GetTopicResponse(const std::string& vehicleId) {
    std::string topic = vehicleId + "/" + "query/response";
    int qos = 0;
    bool retain = false;
