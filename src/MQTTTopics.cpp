...
const ActionHandcartSettingsTopic MQTTTopics::actionHandcartSettingsTopic = ActionHandcartSettingsTopic();
const ActionHandcartSettingsSetTopic MQTTTopics::actionHandcartSettingsSetTopic = ActionHandcartSettingsSetTopic();
const ActionHandcartSettingsGetTopic MQTTTopics::actionHandcartSettingsGetTopic = ActionHandcartSettingsGetTopic();
const ActionHandcartSettingsContentTopic MQTTTopics::actionHandcartSettingsContentTopic = ActionHandcartSettingsContentTopic();
...
std::vector<TopicString> MQTTTopics::GetSubscribeTopics(unsigned int role) {
    ...
    switch(role){
		...
		case 0:
			...
			ret.push_back(actionHandcartSettingsTopic.get("+", "+"));
			ret.push_back(actionHandcartSettingsSetTopic.get("+", "+"));
			ret.push_back(actionHandcartSettingsGetTopic.get("+", "+"));
			ret.push_back(actionHandcartSettingsContentTopic.get("+", "+"));
